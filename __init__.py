...
from .organize_and_write import LogProcessor

# Initialize global file for logging
DEFAULT_LOG_FILE = "demo.txt"

# Create an instance of DataOrganizer for reuse
processor = LogProcessor("demo.txt")


if "litellm" in sys.modules:
    litellm_version = version.parse(get_version("litellm"))
    print(f"\nlitellm version: {litellm_version}\n")

def init():
    _llm_tracker = LlmTracker()
...
#     print(f"10 The counter is here now with these variables (Creating agent) {name, agent_id}") 
